    ...
    <div className="space-y-8">
      <div className="text-center space-y-4 mb-12">
        ...
        <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground">
          <span className="px-3 py-1 bg-secondary rounded-full">⏱️ Time: 8–10 minutes</span>
          <span className="px-3 py-1 bg-secondary rounded-full">Fields marked * are required</span>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl p-6 md:p-8 shadow-lg space-y-6">
        ...
        <FormField label="Website" description="Optional - your business website">
          <Input
            type="url"
        ...
        <div className="pt-6 border-t border-border">
          ...
          <div className="space-y-6">
            ...
            <FormField label="WhatsApp Number" description="Optional - if different from phone">
              <Input
                type="tel"
                placeholder="+1 (555) 123-4567"
